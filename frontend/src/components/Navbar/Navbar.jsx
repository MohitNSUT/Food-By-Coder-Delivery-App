        ...
        <div className='navbar'>
          ...
          <Link to='./'> <img src={assets.logo} alt='logo' className='logo' ></img></Link>
            ...
            <div className='navbar-right'>
                ...
                {!token?<button onClick={()=>{setShowLogin(true)}} className='btn btn-primary'> Sign In </button> : 
                <div className='navbar-profile'>
                    <img className='profile-icon-image' src={assets.profile_icon} alt="" />
                    <ul className='nav-profile-dropdown'>
                        <li>
                           <img src={assets.bag_icon} alt='' ></img> <p>Orders</p> 
                           </li>
                        <hr />
                        <li onClick={logout} >
